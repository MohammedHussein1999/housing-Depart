...
@section('content')
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    <div class="form-group text-right">
                                        ...
                                        <select onchange="updateApartment()" name="buildingId" class="form-select fares"
                                            dir="rtl" id="selectBuilding">
                                        ...
                                        <div class="form-group text-right">
                                            <div class="form-outline">
                                                ...
                                                <select id="selectApartment" name="apartmentNum"
                                                    ...
                                                    <option disabled selected>اختر لتعديل رقم الشقة</option>
                                                </select>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-6 mb-3">
                                    <div class="form-group text-right">
                                        <div class="form-outline">
                                            <label class="form-label" for="form3Example1">رقم الغرفه </label>
                                            <input name="roomNum" value="{{ $room->roomNum }}" type="text"
                                ...
                                <div class=" col-lg-6 col-md-12 mb-3">
                                    <div class="form-group text-right">
                                        <div class="form-outline">
                                            <label class="form-label" for="form3Example1">السعه </label>
                                            <input type="number" value="{{ $room->count }}" name="count"
                                                id="form3Example1" class="form-control" dir="rtl" />
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-6 col-md-12 mb-3">
                                    <div class="form-group text-right">
                                        <div class="form-outline">
                                            ...
                                            <input type="number" value="{{ $room->floorNum }}" name="floorNum"
                                                id="form3Example1" class="form-control" dir="rtl" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="row d-none" dir="rtl">
                                ...
                                <div class="col-md-6 mb-3 text-end d-flex justify-content-center align-items-center mt-4">
                            ...
                            @if ($room->file != null)
                                <div class="col-md-12 mb-3 mt-3">
                                    <div class="d-grid gap-2">
                                        <a href="{{ route('room.download', $room->id) }}" class="btn btn-primary p-2"
                                            type="button">تحميل صوره السكن</a>
                                    </div>
                                </div>
                            @endif
    ...
    <input type="text" class="d-none" id="otherValue" value="{{ $room->other }}">
    <input type="text" class="d-none" id="attachValue" value="{{ $room->attach }}">
    <script>
        ...
        function updateApartment() {
            const selectBuildingTwo = document.getElementById("selectBuilding").value;
        ...
        function createRowAndInputsPrice(index) {
            ...
            selectTd.innerHTML = PriceData[index].selectValue;
        ...
        document.querySelector('.save-price').addEventListener('click', function() {
            for (let i = 0; i < PriceData.length; i++) {
                ...
                PriceData[i].selectValue = document.getElementById(`selectPriceInput${i}`).value;
            }
