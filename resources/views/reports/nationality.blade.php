                ...
                <div class="col-lg-12">
                    <div class="card shadow mb-4 content_building">
                        ...
                        <div class="card-header py-3 text-right">
                            <h6 class="m-0 font-weight-bold">تقرير بالجنسيات</h6>
                        </div>
                        <!-- Card Body -->
                        <div class="card-body">
                            <div class="content_building">
                                <div class="row">
                                    ...
                                    <div class="col-lg-12 mt-5 w-100" id="printableArea">
                                        <table class="table table-striped text-center w-100" dir="rtl"
