                            ...
                            <div class="row" dir="rtl">
                                ...
                                <div class="col-lg-8 ">
                                    <div class="tab-content">
                                        {{-- mistakes --}}
                                        <div class="tab-pane active" id="listSix" role="tabpanel">
                                            <div class="row">
                                                <div class="col-lg-12">
                                                    <div class="row border p-3"
                                                        style="box-shadow: rgba(0, 0, 0, 0.16) 0px 1px 4px;"
                                                        dir="rtl">
                                                        <form action="{{ route('mistake-type.store') }}" method="post">
                                                            @csrf
                                                            <div class="col-lg-8">
                                                                        ...
                                                                        @foreach ($mistake as $item)
                                                                            <tr>
                                                                                ...
                                                                                @if ($item->active == 1)
                                                                                    <td>
                                                                                        <a
                                                                                            href="{{ route('mistake-type.active', $item->id) }}">
                                                                                ...
                                                                                @endif
                                                                                <td>
                                                                                    <a href="{{ route('mistake-type.destroy', $item->id) }}"
