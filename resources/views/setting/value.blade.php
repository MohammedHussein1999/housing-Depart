                            ...
                            <div class="row" dir="rtl">
                                ...
                                <div class="col-lg-8 ">
                                    <div class="tab-content">
                                        {{-- value --}}
                                        <div class="tab-pane active" id="listsit" role="tabpanel">
                                            <div class="row">
                                                <div class="col-lg-12">
                                                        ...
                                                        <form action="{{ route('value.store') }}" method="post">
                                                            ...
                                                            <div class="col-lg-9">
                                                                <div class="form-group text-right">
                                                                    <label for="exampleFormControlSelect1"> نوع
                                                                        السكن</label>
                                                            ...
                                                            <div class="col-lg-9">
                                                                <div class="form-group text-right">
                                                                    <label for="exampleFormControlSelect1"> التكلفه</label>
                                                                    <input name="value" type="number" id="form3Example1"
                                                                        class="form-control" dir="rtl" />
                                                                </div>
                                                            </div>
                                                                        ...
                                                                        @foreach ($value as $item)
                                                                            <tr>
                                                                                ...
                                                                                @if ($item->status == 1)
                                                                                    <td>
                                                                                        <a
                                                                                            href="{{ route('value.status', $item->id) }}">
                                                                                ...
                                                                                @endif
                                                                                <td>
                                                                                    <a href="{{ route('value.destroy', $item->id) }}"
