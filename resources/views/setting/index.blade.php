                            ...
                            <div class="row" dir="rtl">
                                ...
                                <div class="col-lg-8 ">
                                    <div class="tab-content">
                                        {{-- room status --}}
                                        <div class="tab-pane active" id="listThree" role="tabpanel">
                                            <div class="row">
                                                <div class="col-lg-12">
                                                    <div class="row border p-3"
                                                        style="box-shadow: rgba(0, 0, 0, 0.16) 0px 1px 4px;" dir="rtl">
                                                                ...
                                                                <table id="tableSitting-Three"
                                                                    ...
                                                                    <thead class="text-center">
                                                                        <tr>
                                                                            ...
                                                                            <th class="text-center">التسكين المتاح</th>
                                                                        ...
                                                                        @foreach ($roomStatus as $item)
                                                                            <tr>
                                                                                ...
                                                                                @if ($item->status == 1)
                                                                                    <td>
                                                                                        <a
                                                                                            href="{{ route('roomStatus.status', $item->id) }}">
                                                                                ...
                                                                                @endif
                                                                                <td>
                                                                                    <a href="{{ route('roomStatus.destroy', $item->id) }}"
